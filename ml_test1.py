# -*- coding: utf-8 -*-
"""
Created on Tue Oct 13 15:21:37 2020
...
class MLPlay:
    ...
    def update(self, scene_info):
        ...
        if ball_going_down == 1 and platform_center_x >= (ball_destination+3): #decrease the differece bwtween ball position and platform position
             command = "MOVE_LEFT"
        elif ball_going_down == 1 and platform_center_x <= (ball_destination-3):
             command = "MOVE_RIGHT"
        else:
             command = "NONE"
